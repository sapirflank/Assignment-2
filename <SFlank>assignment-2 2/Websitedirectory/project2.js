$(document).ready(function() {
  ...
  $("#receivespambutton").click(function() {
    ...
    if($($("#receivespambutton").children()[0]).attr("src")=="pics/unchecked.png") {
      ...
      $($("#receivespambutton").children()[0]).attr("alt","box is checked");
      $("#spamyn").val("y");
    } else {
      $($("#receivespambutton").children()[0]).attr("src","pics/unchecked.png");
      $($("#receivespambutton").children()[0]).attr("alt","box is unchecked");
      $("#spamyn").val("n");
    }
  });

  $("#receivespambutton").keypress(function(enter) {
    if(enter.which == 32 || enter.which ==13) {
